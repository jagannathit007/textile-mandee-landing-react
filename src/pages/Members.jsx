...
const Members = () => {
  ...
  const fetchMembers = async (search = "", currentPage = 1, append = false) => {
    try {
      ...
      setMembersData((prev) =>
        append ? [...prev, ...formattedUsers] : formattedUsers
      );
      setTotalPages(total);
    } catch (error) {
    ...
    <section className="members-section">
          ...
          <div className="page-title-section">
            <div className="title-content">
              ...
              <h1 className="main-title">
                Trusted By The Community That Powers{" "}
                <span className="title-highlight">
                  India's Textile Industry & Members.
                </span>
              </h1>
            </div>
      ...
      <div className="container">
                  ...
                  <div className="member-image-container">
                    ...
                    <div className="member-overlay">
                      <div className="member-overlay-content">
                        ...
                        <p className="member-profession-overlay">
                          {member.profession}
                        </p>
                      </div>
                    </div>
        ...
        {showModal && selectedMember && (
          ...
          >
            <div
              className="modal-content bg-white rounded-4 shadow-lg position-relative p-4"
                    ...
                    <div className="card border-0 bg-light">
                      <div className="card-body py-2">
                        ...
                        <p className="mb-0 fw-medium text-break">
                          {selectedMember.fullData.emailId || "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    <div className="card border-0 bg-light">
                      <div className="card-body py-2">
                        ...
                        <p className="mb-0 fw-medium">
                          {selectedMember.fullData.mobileNo || "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    <div className="card border-0 bg-light">
                      <div className="card-body py-2">
                        ...
                        <p className="mb-0 fw-medium">
                          {selectedMember.fullData.businesses &&
                          selectedMember.fullData.businesses.length > 0
                            ? selectedMember.fullData.businesses[0]
                                .businessName || "N/A"
                            : "N/A"}
                        </p>
                      </div>
